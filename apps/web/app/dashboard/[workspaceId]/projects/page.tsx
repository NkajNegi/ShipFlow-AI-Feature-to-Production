...
export default function ProjectsPage({
  ...
  const {
    ...
    isFetching,
    refetch,
  } = trpc.project.list.useQuery({ workspaceId });
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Manage your projects and feature requests
          </p>
        </div>
        <Dialog open={isProjectModalOpen} onOpenChange={setIsProjectModalOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <DialogFooter>
              <Button
                onClick={() =>
                  createProject.mutate({ workspaceId, name: newProjectName })
                }
        ...
        <Card className="border-dashed bg-transparent shadow-none">
          <CardContent className="flex flex-col items-center justify-center p-12 text-center">
            ...
            <p className="text-muted-foreground mb-4 max-w-sm">
              Create a project to start organizing your feature requests and
              generating AI PRDs.
            </p>
...
function ProjectCard({
  ...
  const { data: featureRequests, refetch } = trpc.featureRequest.list.useQuery({
    ...
    <Card className="border-border">
      <CardHeader className="flex flex-row justify-between items-start pb-4 border-b">
        <div>
          ...
          <CardDescription>
            Manage feature requests for this project
          </CardDescription>
        </div>
          ...
          >
            ...
            <DialogContent className="sm:max-w-[500px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Describe what you want to build. Our AI will generate a PRD
                  and tasks for you.
                </DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 py-4">
        ...
        <details className="mb-4 rounded-lg border border-border bg-muted/30 p-3">
          ...
          <div className="mt-3 space-y-2 text-xs">
            <p className="text-muted-foreground">
              POST to <code className="text-primary">/api/ingest/feature</code>{" "}
              with this project token:
            </p>
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    className="text-red-500 hover:text-red-600 hover:bg-red-500/10"
                    onClick={() =>
                      setFeatureToDelete({ id: fr.id, title: fr.title })
                    }
                  >
                    {deleteFeature.isPending &&
                    deleteFeature.variables?.id === fr.id ? (
                      <Loader2 className="h-4 w-4 animate-spin" />
                    ) : (
                      <Trash2 className="h-4 w-4" />
                    )}
