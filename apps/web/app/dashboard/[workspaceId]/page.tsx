...
export default function WorkspaceDashboard({
  ...
  const features = trpc.featureRequest.listByWorkspace.useQuery({
    workspaceId,
  });
  ...
  const Sparkline = ({ color }: { color: string }) => (
    ...
    >
      <path
        d="M0 15C5 15 8 5 15 5C22 5 25 15 30 15C35 15 38 8 45 8C52 8 55 12 60 12"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
  ...
  return (
    <div className="relative min-h-screen bg-[#000000] text-foreground flex flex-col p-4 sm:p-6 md:p-8 overflow-x-hidden z-10">
      ...
      <SetupChecklist
        ...
        mode={isWizard ? "wizard" : "dashboard"}
      />
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-3xl font-bold text-white mt-1">
                  {metrics.isLoading ? "-" : (metrics.data?.shippedCount ?? 0)}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-3xl font-bold text-white mt-1">
                  {taskMetrics.isLoading
                    ? "-"
                    : (taskMetrics.data?.overdueTasks?.length ?? 0)}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-3xl font-bold text-white mt-1">
                  {metrics.isLoading ? "-" : (metrics.data?.avgCycleHours ?? 0)}
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
        ...
        <div className="lg:col-span-2 bg-[#0a0a0c] border border-white/5 rounded-2xl p-5 shadow-lg">
          ...
          <div className="flex gap-4 mb-8">
            ...
            <div className="flex items-center gap-2 px-2 py-1 rounded bg-[#111] border border-white/5 text-[10px] font-bold text-muted-foreground">
              <div className="w-2 h-2 rounded-full bg-[#f97316] shadow-[0_0_8px_rgba(249,115,22,0.8)]" />{" "}
              IN PROGRESS {cInProgress}
            </div>
            <div className="flex items-center gap-2 px-2 py-1 rounded bg-[#111] border border-white/5 text-[10px] font-bold text-muted-foreground">
            ...
            <div className="flex items-center gap-2 px-2 py-1 rounded bg-[#111] border border-white/5 text-[10px] font-bold text-muted-foreground">
              <div className="w-2 h-2 rounded-full bg-[#22c55e] shadow-[0_0_8px_rgba(34,197,94,0.8)]" />{" "}
              DONE {cDone}
            </div>
          </div>
              ...
              >
                ...
                {cDone > 0 && (
                  <circle
                    ...
                    stroke="#22c55e"
                    strokeWidth="12"
                    strokeDasharray={getStroke(cDone)}
                    strokeLinecap="round"
                    className="opacity-80 drop-shadow-[0_0_10px_rgba(34,197,94,0.5)]"
                  />
                )}
                ...
                {cReview > 0 && (
                  <circle
                    ...
                    stroke="#0ea5e9"
                    strokeWidth="12"
                    strokeDasharray={getStroke(cReview)}
                    strokeDashoffset={-(cDone / tTotal) * 251}
                    strokeLinecap="round"
                    className="opacity-80 drop-shadow-[0_0_10px_rgba(14,165,233,0.5)]"
                  />
                )}
                ...
                {cInProgress > 0 && (
                  <circle
                    ...
                    stroke="#f97316"
                    strokeWidth="12"
                    strokeDasharray={getStroke(cInProgress)}
                    strokeDashoffset={-((cDone + cReview) / tTotal) * 251}
                    strokeLinecap="round"
                    className="opacity-80 drop-shadow-[0_0_10px_rgba(249,115,22,0.5)]"
                  />
                )}
              </svg>
              ...
              <div className="absolute left-8 right-0 bottom-6 h-px">
                ...
                >
                  ...
                  <circle
                    ...
                    r="3"
                    fill="#0ea5e9"
                    className="shadow-[0_0_8px_rgba(14,165,233,0.8)]"
                  />
                  <circle
                    cx="25%"
                    cy="0"
                  ...
                  <circle
                    ...
                    r="3"
                    fill="#facc15"
                    className="shadow-[0_0_8px_rgba(250,204,21,0.8)]"
                  />
                  <circle
                    cx="70%"
                    cy="0"
                  ...
                  <circle
                    ...
                    r="3"
                    fill="#4ade80"
                    className="shadow-[0_0_8px_rgba(74,222,128,0.8)]"
                  />
                  <circle
                    cx="100%"
                    cy="0"
                  ...
                  <div key={comment.id} className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-[12px]">
                        ...
                        <Link
                          href={`/dashboard/${workspaceId}/board?task=${comment.task.id}`}
                          className="text-[#c084fc] hover:underline font-medium"
                        >
                          {comment.task.ref || comment.task.title}
                        </Link>
                      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        <Link
          ...
          className="group bg-white/[0.02] border border-white/5 hover:border-white/10 hover:bg-white/5 rounded-xl p-4 transition-all flex items-center gap-4"
        >
            ...
            {taskMetrics.isLoading ? (
              ...
              <div className="space-y-3">
                {taskMetrics.data?.myTasks.map((t) => (
                  <Link
                    key={t.id}
                    href={`/dashboard/${workspaceId}/board?task=${t.id}`}
                  ...
                  >
                    <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/5 hover:border-white/10 transition-colors">
                      <div className="text-[12px] font-bold text-white mb-1 truncate group-hover:text-[#c084fc] transition-colors">
                        {t.title}
                      </div>
                      <div className="text-[10px] text-muted-foreground truncate">
                        {t.project?.name}{" "}
                        {t.prd?.featureRequest.title
                          ? `• ${t.prd.featureRequest.title}`
                          : ""}
                      </div>
                    </div>
                  ...
                  >
                    <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/5 hover:border-white/10 transition-colors h-full flex flex-col justify-between">
                      <div>
                        ...
                        <div className="text-[13px] font-bold text-white line-clamp-2 leading-snug group-hover:text-[#facc15] transition-colors">
                          {f.title}
                        </div>
                      </div>
                      <div className="text-[10px] text-muted-foreground mt-3 truncate">
                        {f.project.name}
                      </div>
                    </div>
                  </Link>
        ...
        <div className="lg:col-span-1 bg-[#0a0a0c] border border-white/5 rounded-2xl p-5 shadow-lg flex flex-col">
          ...
          <div className="flex items-center gap-4 mt-2">
            <div className="relative w-20 h-20 shrink-0">
              ...
              >
                ...
                <circle
                  ...
                  strokeWidth="12"
                  strokeDasharray={
                    taskMetrics.data?.overdueTasks?.length ? "180 251" : "251 0"
                  }
                  strokeLinecap="round"
                  className={`drop-shadow-[0_0_10px_${taskMetrics.data?.overdueTasks?.length ? "rgba(249,115,22,0.4)" : "rgba(74,222,128,0.4)"}] transition-all duration-1000`}
                />
              </svg>
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                <span className="text-[16px] font-bold text-white leading-none">
                  {taskMetrics.data?.overdueTasks?.length ? "80%" : "100%"}
                </span>
                <span className="text-[8px] font-semibold text-muted-foreground mt-0.5">
                  {taskMetrics.data?.overdueTasks?.length
                    ? "Needs Attn"
                    : "On Track"}
                </span>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <div
                  className={`w-3.5 h-3.5 rounded-full border ${taskMetrics.data?.overdueTasks?.length ? "border-[#f97316]/50 bg-[#f97316]/10" : "border-[#4ade80]/50"} flex items-center justify-center shrink-0`}
                >
                  {taskMetrics.data?.overdueTasks?.length ? (
                ...
                <span className="text-[10px] text-muted-foreground font-medium">
                  {taskMetrics.data?.overdueTasks?.length
                    ? `${taskMetrics.data.overdueTasks.length} overdue task(s)`
                    : "No overdue tasks"}
                </span>
              </div>
              <div className="flex items-center gap-2">
