...
export function HeroOrbitalGraphic() {
  return (
    <div className="relative w-full h-full min-h-[500px] flex items-center justify-center pt-10 select-none">
      ...
      {/* Orbital Rings Background - Golden/Orange styling */}
      ...
      <div className="absolute inset-0 z-30 pointer-events-none">
        ...
        <div className="absolute top-[5%] right-[5%] transition-transform hover:-translate-y-1">
        ...
        <div className="absolute top-[40%] right-[-10%] transition-transform hover:-translate-y-1">
          <div className="relative group">
            <div className="relative flex items-center gap-4 p-3 pr-5 rounded-2xl bg-gradient-to-b from-white/[0.04] to-black/60 backdrop-blur-xl border border-white/[0.05] shadow-[0_10px_40px_rgba(0,0,0,0.8)] overflow-hidden">
        ...
        <div className="absolute bottom-[10%] right-[5%] transition-transform hover:-translate-y-1">
          <div className="relative group">
            <div className="relative flex items-center gap-4 p-3 pr-5 rounded-2xl bg-gradient-to-b from-white/[0.04] to-black/60 backdrop-blur-xl border border-white/[0.05] shadow-[0_10px_40px_rgba(0,0,0,0.8)] overflow-hidden">
        ...
        <div className="absolute bottom-[10%] left-[5%] transition-transform hover:-translate-y-1">
          <div className="relative group">
            <div className="relative flex items-center gap-4 p-3 pr-5 rounded-2xl bg-gradient-to-b from-white/[0.04] to-black/60 backdrop-blur-xl border border-white/[0.05] shadow-[0_10px_40px_rgba(0,0,0,0.8)] overflow-hidden">
        ...
        <div className="absolute top-[25%] left-[-5%] transition-transform hover:-translate-y-1">
          <div className="relative group">
            <div className="relative flex items-center gap-4 p-3 pr-5 rounded-2xl bg-gradient-to-b from-white/[0.04] to-black/60 backdrop-blur-xl border border-white/[0.05] shadow-[0_10px_40px_rgba(0,0,0,0.8)] overflow-hidden">
      ...
      <div className="absolute bottom-[5%] left-1/2 -translate-x-1/2 px-5 py-2.5 rounded-full bg-black/80 border border-white/10 shadow-2xl backdrop-blur-xl z-40 animate-pulse">
